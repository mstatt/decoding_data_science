                        ...
                        children: [
                            {
                                ...
                                name: "Innovation",
                                data: {
                                    relation: '<h4>Innovation</h4><b>Description:</b><br/> Lets pick a direction, are we going to solve a problem or capitalize on an opportunity?<br/><br/><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#jensenH">Jensen Huang on Competing</button> <br/><br/> '
                                },
                                children: [
                ...
                children: [
                    {
                        ...
                        children: [
...

                            {
                                ...
                                data: {
                                    relation: '<h4>DO NOT MAKE IT WORSE</h4><b>Description:</b><br/>Of critical importance is to constantly review feedback of the solution ensuring that it is not making things worse through "Features", "Enhancements" or a awful UI.<br/> <br/><a href="worse.jpeg" target="_blank">Graphic</a>'
                                },
                                children: [
                    ...
                    },
                    {
                        ...
                        children: [
...

                            {
                                ...
                                name: "Who owns what?",
                                data: {
                                    relation: '<h4>Who owns how much?</h4><b>Description:</b><br/>Understand how much of your solution providers own or are entitled to.<br/> <br/><a href="Screenshot from 2024-03-13 10-48-59.png" target="_blank">Graphic</a><br/><br/><u>Your Passwords and Personal Images are catalogued:</u><br/><br/><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#microsoftrecallLabel">Microsoft Recall</button>'
                                },
                                children: [
                                ]
                            },
